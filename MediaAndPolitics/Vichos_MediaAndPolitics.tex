...
\tightlist
\item
  \textbf{H1:} Negative effect on liberal attitudes \emph{(`first-time
  sensitivity')}.
\end{itemize}
...
\begin{itemize}
\item
  Sharp RDD compares first-time voters in 2012 vs.~2016 (age 26 cutoff
  in 2020).
\item
...
\begin{itemize}
\item
  Constructed from 2020 ANES items on media trust, independence, and
  access.
\item
...
\tightlist
\item
  2020 ANES, nationally representative, rich in political and
